package me.iparis.notenoughcoins.utils;
...
public class Utils {
    // Volé à Biscut & Moulberry et utilisé pour détecter si dans skyblock
    ...
    public static int getTax(int price) {
        float taxRate = 0.01f;
        if (price >= 1000000) {
            taxRate = 0.02f; // 2% = taxe de départ + plus de 1m de taxe
        }
    ...
    public static void updateSkyblockScoreboard() { // Merci à NEU
    ...
    public static String getIDFromItemStack(ItemStack stack) { // Merci à NEU
